...
if __name__ == "__main__":
    ...
    if args.checkpoint_file:
        ...
        try:
            ...
            print(f"Error: Checkpoint file '{args.checkpoint_file}' not found. Please run the script without --checkpoint_file to start a new run, or provide a valid checkpoint.")
            exit(1)
